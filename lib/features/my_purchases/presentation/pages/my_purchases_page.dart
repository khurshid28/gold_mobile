    ...
    return Container(
      ...
      child: Column(
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 6.h),
                      Text(
                        NumberFormat.currency(symbol: '', decimalDigits: 0).format(purchase.totalPrice) + ' so\'m',
                        style: TextStyle(
                          fontSize: 16.sp,
                          fontWeight: FontWeight.w700,
                          color: AppColors.gold,
          ...
          if (purchase.isInstallment && purchase.installmentDetails != null) ...[
            ...
            _InstallmentDetails(
              ...
              onViewDetails: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => InstallmentDetailsPage(purchase: purchase),
                  ),
                );
              },
            ),
          ...
          Row(
            ...
            children: [
              Expanded(
                child: _InfoColumn(
                  label: 'Oylik',
                  value: NumberFormat.currency(symbol: '', decimalDigits: 0).format(details.monthlyPayment),
                  unit: 'so\'m',
                  isDark: isDark,
                ),
              ),
              ...
              Expanded(
                child: _InfoColumn(
                  label: 'Qolgan',
                  value: NumberFormat.currency(symbol: '', decimalDigits: 0).format(details.remainingAmount),
                  unit: 'so\'m',
                  isDark: isDark,
                ),
              ),
